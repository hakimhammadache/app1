...
<div class="row col-12 mx-0 px-0 border">
    <div class="row col-lg-3 col-12  mx-0 px-0 border">
        ...
        <div class="col-lg-12 col-sm-6 shadow">
            ...
            <p class="text-capitalize"><span class="font-weight-bold titre">Nom:</span><?= $params['bm']->nom_bien?></p>

            <p class="text-capitalize"><span class="font-weight-bold titre">Type:</span><?= $params['Typebmobile']->libelle_tp_mob?></p>
            
            <p class="text-capitalize"><span class="font-weight-bold titre">Numero:</span><?= $params['bm']->numero?></p>
...
<h3 class="mx-auto titre" >Les Documents de: <?= $params['bm']->nom_bien?> </h3>
<div class=" row col-12">
  ...
  <button class="btn btn-outline-success btn-sm  ml-auto shadow "
            type="button" 
            data-toggle="modal"
            data-target="#docform" 
            data-bien="<?= $params['bm']->id?>" 
            data-etab ="<?= $params['bm']->id_etab?>"  
...
?></th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <?php endforeach ?>
                      <?php foreach ($doc->getBienmobile() as $bm): ?>
                    <td class="text-capitalize d-none" id="tp"><?= $bm->nom_bien?></td>
                    <?php endforeach ?> 
                    <td>
 ...
 <div class="modal fade" id="docform" tabindex="-1" role="dialog" aria-labelledby="docformLabel" aria-hidden="true">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">  
        <?php include VIEWS . 'Bienmobile/doc.php';?>
      </div>
